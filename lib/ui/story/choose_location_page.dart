...
class _StateChooseLocation extends State<ChooseLocationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<FormStoryProvider>(
        builder: (context, value, child) {
          if (value.currentPosition != null && mapboxMap != null) {
              ...
              Positioned.fill(
                child: MapWidget(
                  ...
                  cameraOptions: CameraOptions(
                    center:  value.currentPosition==null ? null :Point(
                      coordinates: Position(
                        value.currentPosition!.longitude,
                        value.currentPosition!.latitude,
                      ),
                  ...
                  onTapListener: (context) async {
                    mapboxMap!.annotations.removeAnnotationManagerById(
                      _pointAnnotationManager.id,
                    );
                    ...
                    setLocation(
                      double.parse(context.point.coordinates.lat.toString()),
                      double.parse(context.point.coordinates.lng.toString()),
                    );
                  },
                ),
              ),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: value.selectedLocation == null
                            ? null
                            : () {
                                context.push("/story/form",extra: true);
                              },
  ...
  void setLocation(double lat, double lng) {
    context.read<FormStoryProvider>().setSelectedLocation(
      MyLtLng(latitude: lat, longitude: lng),
    );
  }
}
